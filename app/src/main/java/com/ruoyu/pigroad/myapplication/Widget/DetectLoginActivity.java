...
import com.ruoyu.pigroad.myapplication.Ui.LoginResultActivity;
import com.ruoyu.pigroad.myapplication.Util.FaceError;
import com.ruoyu.pigroad.myapplication.Util.ImageUtil;
...
//                            startActivity(intent);
//                            finish();
                              Log.i("ppppp","user_id:"+getIntent().getStringExtra("user_id")+",userinfo:"+userInfo);
                              if (getIntent().getStringExtra("user_id").equals(userInfo)){
                                  Intent intent=new Intent();
                                  setResult(2,intent);
                                  finish();
                              }else {
