...
import com.ruoyu.pigroad.myapplication.Widget.BrightnessTools;
import com.ruoyu.pigroad.myapplication.Widget.FaceDetectActivity;
import com.ruoyu.pigroad.myapplication.Widget.FaceRoundView;
import com.ruoyu.pigroad.myapplication.Widget.ImageSaveUtil;
import com.ruoyu.pigroad.myapplication.Widget.TCircleProgressView;
import com.ruoyu.pigroad.myapplication.Widget.WaveHelper;
import com.ruoyu.pigroad.myapplication.Widget.WaveView;
 ...
 */
public class UpFaceReActivity  extends AppCompatActivity {
    ...
    private void initView() {
        ...
        cameraImageSource.getCameraControl().setPermissionCallback(new PermissionCallback() {
            ...
            public boolean onRequestPermission() {
                ActivityCompat.requestPermissions(UpFaceReActivity.this,
...
//                Color.parseColor("#3cf16d7a"));
    ...
    private boolean saveFaceBmp(FaceFilter.TrackedModel model) {
        ...
        if (face != null) {
            Log.d("save", "save bmp");
            ImageSaveUtil.saveCameraBitmap(UpFaceReActivity.this, face, "head_tmp.jpg");
        }
    ...
    private void initBrightness() {
        int brightness = BrightnessTools.getScreenBrightness(UpFaceReActivity.this);
        if (brightness < 200) {
    ...
    private  class InnerHandler extends Handler {
        private WeakReference<UpFaceReActivity> mWeakReference;

        public InnerHandler(UpFaceReActivity activity) {
            super();
            this.mWeakReference = new WeakReference<UpFaceReActivity>(activity);
        }
        ...
        public void handleMessage(Message msg) {
            ...
            UpFaceReActivity activity = mWeakReference.get();
            if (activity == null) {
                return;
            }
            if (msg == null) {
