...
import com.ruoyu.pigroad.myapplication.Adapter.CouponManageOverAdapter;
import com.ruoyu.pigroad.myapplication.Adapter.CouponManageUsedAdapter;
import com.ruoyu.pigroad.myapplication.Bean.CouponManageBean3;
...
public class CouponFragment3 extends Fragment {
    ...
    private List<CouponManageBean3> datas=new ArrayList<>();
    private CouponManageOverAdapter adapter;
    private String login_token;
    private RecyclerView recyclerView;

    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.coupon_fragment3,container,false);
        return v;
    }
    ...
    private void init() {
        ...
        recyclerView=getActivity().findViewById(R.id.rv3);
        adapter=new CouponManageOverAdapter(getActivity(),datas);
    ...
    private void getData(){
        OkGo.<String>post(API_URL+"?request=private.coupon.get.expire.coupon.list&token="+login_token+"&platform=app")
                            ...
                            if (code == 0){
                                ...
                                if (data.length() == 0){
                                    ...
                                    for (int i=0;i<data.length();i++){
                                        ...
                                        CouponManageBean3 bean=new CouponManageBean3();
